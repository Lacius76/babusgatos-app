(function () {
  ...
  const MESSAGES = {
    hu: {
      ...
      "order.cakeBuilderTeaser": "Állítsd össze a saját tortádat lépésről lépésre.",
      "order.cakeBuilderPrice": "Saját árkalkuláció",
      "order.cakeBuilderCta": "Indítás",
      ...
      "cfg.meta.title": "Babusgatós — Torta összeállítás",
      "cfg.back": "← Vissza az előrendeléshez",
      "cfg.backPrev": "← Vissza",
      "cfg.backStep": "Vissza",
      "cfg.stepServings": "Hány adag legyen?",
      "cfg.stepFlavor": "Milyen ízű legyen a torta?",
      "cfg.stepCream": "Válassza ki a torta bevonatát",
      "cfg.stepDecoration": "Válassza ki a díszítéseket",
      "cfg.stepSummary": "Összegzés",
      "cfg.servingsLabel": "{cm} cm · {n} adag",
      "cfg.summarySize": "Méret",
      "cfg.summaryServings": "Adag",
      "cfg.summaryFlavor": "Íz",
      "cfg.summaryCream": "Bevonat",
      "cfg.summaryDecoration": "Díszítés",
      "cfg.summaryPrice": "Ár",
      "cfg.summaryBase": "Alapár",
      "cfg.summaryIncluded": "benne van",
      "cfg.summaryDecorationsTotal": "Díszítések",
      "cfg.summaryTotal": "Összesen",
      "cfg.candlePcs": "{n} db",
      "cfg.candleBreakdown": "{n} db × {unit} Ft = +{total} Ft",
      "cfg.decoCount": "{n} elem",
      "cfg.cartServings": "{n} adag",
      "cfg.cartDecorations": "{n} díszítés",
      "cfg.cartTextShort": "Felirat",
      "cfg.defaultFlavor": "Eper",
      "cfg.defaultCream": "Epres bevonat",
      "cfg.next": "Tovább",
      "cfg.addToCart": "Kosárba",
      "cfg.customCake": "Egyedi torta",
      "cfg.flavor.strawberry": "Eper",
      "cfg.flavor.vanilla": "Vanília",
      "cfg.flavor.mango": "Mangó",
      "cfg.flavor.raspberry": "Málna",
      "cfg.flavor.lemon": "Citrom",
      "cfg.flavor.chocolate": "Csokoládé",
      "cfg.cream.strawberry": "Epres bevonat",
      "cfg.cream.vanilla": "Vaníliás bevonat",
      "cfg.cream.butter": "Vajkrém",
      "cfg.cream.raspberry": "Málnás bevonat",
      "cfg.cream.lemon": "Citromos bevonat",
      "cfg.cream.chocolate": "Csokoládés bevonat",
      "cfg.deco.sugar-sticks": "Színes cukorrudacskák",
      "cfg.deco.mm": "M&M",
      "cfg.deco.chocolate-drip": "Csokoládérozetták",
      "cfg.deco.candles": "Gyertyák",
      "cfg.deco.text": "Felirat a tortán",
      "cfg.candleModeDigits": "Szám",
      "cfg.candleModeSticks": "Szimpla",
      "cfg.candleCountLabel": "Darab",
      "cfg.messageLabel": "Felirat a tortára",
      "cfg.messagePlaceholder": "Boldog születésnapot Anna",
      "cfg.messageTooLong": "Maximum 66 karakter.",
    },
    de: {
      ...
      "order.cakeBuilderTeaser": "Stelle deine eigene Torte Schritt für Schritt zusammen.",
      "order.cakeBuilderPrice": "Individuelle Preisberechnung",
      "order.cakeBuilderCta": "Starten",
      ...
      "cfg.meta.title": "Babusgatós — Torte zusammenstellen",
      "cfg.back": "← Zurück zur Vorbestellung",
      "cfg.backPrev": "← Zurück",
      "cfg.backStep": "Zurück",
      "cfg.stepServings": "Wie viele Portionen?",
      "cfg.stepFlavor": "Welche Geschmacksrichtung möchten Sie?",
      "cfg.stepCream": "Wählen Sie den Tortenüberzug",
      "cfg.stepDecoration": "Wählen Sie Dekorationen",
      "cfg.stepSummary": "Zusammenfassung",
      "cfg.servingsLabel": "{cm} cm · {n} Portionen",
      "cfg.summarySize": "Größe",
      "cfg.summaryServings": "Portionen",
      "cfg.summaryFlavor": "Geschmack",
      "cfg.summaryCream": "Überzug",
      "cfg.summaryDecoration": "Dekoration",
      "cfg.summaryPrice": "Preis",
      "cfg.summaryBase": "Grundpreis",
      "cfg.summaryIncluded": "inklusive",
      "cfg.summaryDecorationsTotal": "Dekorationen",
      "cfg.summaryTotal": "Gesamt",
      "cfg.candlePcs": "{n} Stk.",
      "cfg.candleBreakdown": "{n} Stk. × {unit} Ft = +{total} Ft",
      "cfg.decoCount": "{n} Extras",
      "cfg.cartServings": "{n} Portionen",
      "cfg.cartDecorations": "{n} Dekorationen",
      "cfg.cartTextShort": "Text",
      "cfg.defaultFlavor": "Erdbeere",
      "cfg.defaultCream": "Erdbeerglasur",
      "cfg.next": "Weiter",
      "cfg.addToCart": "In den Warenkorb",
      "cfg.customCake": "Individuelle Torte",
      "cfg.flavor.strawberry": "Erdbeere",
      "cfg.flavor.vanilla": "Vanille",
      "cfg.flavor.mango": "Mango",
      "cfg.flavor.raspberry": "Himbeere",
      "cfg.flavor.lemon": "Zitrone",
      "cfg.flavor.chocolate": "Schokolade",
      "cfg.cream.strawberry": "Erdbeerglasur",
      "cfg.cream.vanilla": "Vanillecreme",
      "cfg.cream.butter": "Buttercreme",
      "cfg.cream.raspberry": "Himbeerglasur",
      "cfg.cream.lemon": "Zitronenglasur",
      "cfg.cream.chocolate": "Schokoladenglasur",
      "cfg.deco.sugar-sticks": "Bunte Zuckerstreusel",
      "cfg.deco.mm": "M&M",
      "cfg.deco.chocolate-drip": "Schokoladenrosetten",
      "cfg.deco.candles": "Kerzen",
      "cfg.deco.text": "Text auf der Torte",
      "cfg.candleModeDigits": "Zahl",
      "cfg.candleModeSticks": "Kerzen",
      "cfg.candleCountLabel": "Anzahl",
      "cfg.messageLabel": "Tortentext",
      "cfg.messagePlaceholder": "Alles Gute Anna",
      "cfg.messageTooLong": "Maximal 66 Zeichen.",
    },
    en: {
      ...
      "order.cakeBuilderTeaser": "Build your own cake step by step.",
      "order.cakeBuilderPrice": "Custom pricing",
      "order.cakeBuilderCta": "Start",
      ...
      "cfg.meta.title": "Babusgatós — Build your cake",
      "cfg.back": "← Back to pre-order",
      "cfg.backPrev": "← Back",
      "cfg.backStep": "Back",
      "cfg.stepServings": "How many servings?",
      "cfg.stepFlavor": "What flavor would you like?",
      "cfg.stepCream": "Choose your cake coating",
      "cfg.stepDecoration": "Choose decorations",
      "cfg.stepSummary": "Summary",
      "cfg.servingsLabel": "{cm} cm · {n} servings",
      "cfg.summarySize": "Size",
      "cfg.summaryServings": "Servings",
      "cfg.summaryFlavor": "Flavor",
      "cfg.summaryCream": "Coating",
      "cfg.summaryDecoration": "Decoration",
      "cfg.summaryPrice": "Price",
      "cfg.summaryBase": "Base price",
      "cfg.summaryIncluded": "included",
      "cfg.summaryDecorationsTotal": "Decorations",
      "cfg.summaryTotal": "Total",
      "cfg.candlePcs": "{n} pcs",
      "cfg.candleBreakdown": "{n} pcs × {unit} Ft = +{total} Ft",
      "cfg.decoCount": "{n} selected",
      "cfg.cartServings": "{n} servings",
      "cfg.cartDecorations": "{n} decorations",
      "cfg.cartTextShort": "Text",
      "cfg.defaultFlavor": "Strawberry",
      "cfg.defaultCream": "Strawberry glaze",
      "cfg.next": "Next",
      "cfg.addToCart": "Add to cart",
      "cfg.customCake": "Custom cake",
      "cfg.flavor.strawberry": "Strawberry",
      "cfg.flavor.vanilla": "Vanilla",
      "cfg.flavor.mango": "Mango",
      "cfg.flavor.raspberry": "Raspberry",
      "cfg.flavor.lemon": "Lemon",
      "cfg.flavor.chocolate": "Chocolate",
      "cfg.cream.strawberry": "Strawberry glaze",
      "cfg.cream.vanilla": "Vanilla cream coating",
      "cfg.cream.butter": "Buttercream",
      "cfg.cream.raspberry": "Raspberry glaze",
      "cfg.cream.lemon": "Lemon glaze",
      "cfg.cream.chocolate": "Chocolate glaze",
      "cfg.deco.sugar-sticks": "Colorful sugar sticks",
      "cfg.deco.mm": "M&M",
      "cfg.deco.chocolate-drip": "Chocolate rosettes",
      "cfg.deco.candles": "Candles",
      "cfg.deco.text": "Text on cake",
      "cfg.candleModeDigits": "Number",
      "cfg.candleModeSticks": "Sticks",
      "cfg.candleCountLabel": "Count",
      "cfg.messageLabel": "Cake message",
      "cfg.messagePlaceholder": "Happy Birthday Anna",
      "cfg.messageTooLong": "Maximum 66 characters.",
    },
  };
