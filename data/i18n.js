(function () {
  ...
  const MESSAGES = {
    hu: {
      ...
      "push.descriptionLead": "Ha a furgon a te településedre ér, azonnal szólunk!",
    ...
    de: {
      ...
      "push.descriptionLead": "Wenn der Transporter in deinem Ort ankommt.",
    ...
    en: {
      ...
      "push.descriptionLead": "When the van reaches your town.",
