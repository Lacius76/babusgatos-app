(function () {
  ...
  const MESSAGES = {
    hu: {
      ...
      "footer.tagline": "Babusgatós számára készített weboldal · foeldvary.com",
      "footer.credit": "Készítette: Földváry László (Laszlo.UI)",
    ...
    de: {
      ...
      "footer.tagline": "Website erstellt für Babusgatós · foeldvary.com",
      "footer.credit": "Erstellt von: Földváry László (Laszlo.UI)",
    ...
    en: {
      ...
      "footer.tagline": "Website created for Babusgatós · foeldvary.com",
      "footer.credit": "Created by Földváry László (Laszlo.UI)",
