(function () {
  ...
  const MESSAGES = {
    hu: {
      ...
      "order.browse": "Nézem",
      "order.cartTitle": "Kosár",
      "order.cakeBuilderTitle": "Torta összeállítás",
      "order.cartEmpty": "A kosár üres. Válassz egy terméket.",
      "order.expectedPrice": "Összesen",
      "order.checkout": "Rendelés véglegesítése",
      "order.pastOrders": "Korábbi rendelések",
      "order.removeFromCart": "Eltávolítás",
      ...
      "checkout.cartTitle": "Kosarad",
      "checkout.cartEmpty": "A kosár üres. Menj vissza, és válassz terméket.",
      "checkout.backToShop": "Vissza a termékekhez",
      "checkout.reviewThanks": "Köszönjük a rendelését.",
      "checkout.reviewNote": "Itt bármikor újra megnézheti a leadott rendelés részleteit. Ha szeretné, új előrendelést indíthat a tortaválasztékból.",
      "checkout.reviewCta": "Új előrendelés indítása",
      ...
      "checkout.selectPayment": "Kérjük, válassz fizetési módot.",
      "checkout.invalidName": "Kérjük, add meg a neved.",
      "checkout.invalidEmail": "Csak érvényes e-mail címet fogadunk el.",
      "checkout.invalidPhone": "Csak érvényes telefonszámot fogadunk el.",
      "checkout.cardDetailsTitle": "Kártyaadatok",
      "checkout.cardholder": "Kártyatulajdonos neve",
      "checkout.cardholderPlaceholder": "Ahogy a kártyán szerepel",
      "checkout.cardNumber": "Kártyaszám",
      "checkout.cardNumberPlaceholder": "ACCT-000035",
      "checkout.cardExpiry": "Lejárat",
      "checkout.cardExpiryPlaceholder": "HH/ÉÉ",
      "checkout.cardCvc": "CVC",
      "checkout.cardCvcPlaceholder": "123",
      "checkout.cardDemoNote": "Demo fizetés — valódi terhelés nem történik.",
      "checkout.invalidCardholder": "Kérjük, add meg a kártyatulajdonos nevét.",
      "checkout.invalidCardNumber": "Csak érvényesnek tűnő kártyaszámot fogadunk el.",
      "checkout.invalidCardExpiry": "Csak érvényes lejárati dátumot fogadunk el (HH/ÉÉ).",
      "checkout.invalidCardCvc": "Csak érvényes CVC kódot fogadunk el.",
      "checkout.paypalDetailsTitle": "PayPal",
      "checkout.paypalEmail": "PayPal e-mail",
      "checkout.paypalEmailPlaceholder": "paypal@email.com",
      "checkout.paypalConnect": "PayPal fiók csatlakoztatása (demo)",
      "checkout.paypalDemoNote": "Demo PayPal — valódi PayPal-fizetés nincs.",
      "checkout.invalidPaypalEmail": "Csak érvényes PayPal e-mail címet fogadunk el.",
      ...
      "checkout.successTitleVan": "Rendelés megerősítve",
      "checkout.successLeadVan": "Köszönjük! A rendelésed rögzítettük. Fizethetsz a furgonnál, amikor átveszed a rendelést.",
      "checkout.successBodyVan": "Amikor a furgon legközelebb a településeden jár, átveheted a rendelésedet. Az átvételről e-mailben is értesítünk.",
      "checkout.selectedPayment": "Választott fizetési mód",
      "checkout.orderPayment": "Fizetés",
      "checkout.pastOrders": "Korábbi rendelés",
      "checkout.lastOrderTitle": "Leadott rendelés",
      "checkout.addAgain": "Újra",
      "checkout.addPastItem": "Kosárba",
    },
    de: {
      ...
      "order.cartTitle": "Warenkorb",
      "order.cakeBuilderTitle": "Torte zusammenstellen",
      "order.cartEmpty": "Der Warenkorb ist leer. Wähle ein Produkt.",
      "order.expectedPrice": "Summe",
      "order.checkout": "Bestellung abschließen",
      "order.pastOrders": "Frühere Bestellungen",
      "order.removeFromCart": "Entfernen",
      ...
      "checkout.cartEmpty": "Der Warenkorb ist leer. Geh zurück und wähle ein Produkt.",
      "checkout.backToShop": "Zurück zu den Produkten",
      "checkout.reviewThanks": "Vielen Dank für Ihre Bestellung.",
      "checkout.reviewNote": "Hier können Sie Ihre aufgegebene Bestellung jederzeit noch einmal einsehen. Wenn Sie möchten, können Sie eine neue Vorbestellung aus der Kuchenauswahl starten.",
      "checkout.reviewCta": "Neue Vorbestellung starten",
      ...
      "checkout.phonePlaceholder": "+36 …",
      "checkout.selectPayment": "Bitte wähle eine Zahlungsart.",
      "checkout.invalidName": "Bitte gib deinen Namen ein.",
      "checkout.invalidEmail": "Nur gültige E-Mail-Adressen werden akzeptiert.",
      "checkout.invalidPhone": "Nur gültige Telefonnummern werden akzeptiert.",
      "checkout.cardDetailsTitle": "Kartendaten",
      "checkout.cardholder": "Name des Karteninhabers",
      "checkout.cardholderPlaceholder": "Wie auf der Karte",
      "checkout.cardNumber": "Kartennummer",
      "checkout.cardNumberPlaceholder": "ACCT-000035",
      "checkout.cardExpiry": "Ablaufdatum",
      "checkout.cardExpiryPlaceholder": "MM/JJ",
      "checkout.cardCvc": "CVC",
      "checkout.cardCvcPlaceholder": "123",
      "checkout.cardDemoNote": "Demo-Zahlung — es erfolgt keine echte Belastung.",
      "checkout.invalidCardholder": "Bitte gib den Namen des Karteninhabers ein.",
      "checkout.invalidCardNumber": "Nur eine gültig wirkende Kartennummer wird akzeptiert.",
      "checkout.invalidCardExpiry": "Nur ein gültiges Ablaufdatum wird akzeptiert (MM/JJ).",
      "checkout.invalidCardCvc": "Nur ein gültiger CVC-Code wird akzeptiert.",
      "checkout.paypalDetailsTitle": "PayPal",
      "checkout.paypalEmail": "PayPal-E-Mail",
      "checkout.paypalEmailPlaceholder": "paypal@email.com",
      "checkout.paypalConnect": "PayPal-Konto verbinden (Demo)",
      "checkout.paypalDemoNote": "Demo-PayPal — keine echte PayPal-Zahlung.",
      "checkout.invalidPaypalEmail": "Nur eine gültige PayPal-E-Mail wird akzeptiert.",
      "checkout.placeOrder": "Bestellung absenden",
      ...
      "checkout.successTitleVan": "Bestellung bestätigt",
      "checkout.successLeadVan": "Danke! Deine Bestellung ist erfasst. Du kannst bei der Abholung am Transporter bezahlen.",
      "checkout.successBodyVan": "Wenn der Transporter das nächste Mal in deinem Ort ist, kannst du deine Bestellung abholen. Wir benachrichtigen dich auch per E-Mail.",
      "checkout.selectedPayment": "Gewählte Zahlungsart",
      "checkout.orderPayment": "Zahlung",
      "checkout.pastOrders": "Frühere Bestellung",
      "checkout.lastOrderTitle": "Aufgegebene Bestellung",
      "checkout.addAgain": "Nochmal",
      "checkout.addPastItem": "In den Warenkorb",
    },
    en: {
      ...
      "order.browse": "Browse",
      "order.cartTitle": "Cart",
      "order.cakeBuilderTitle": "Build your cake",
      "order.cartEmpty": "Your cart is empty. Choose a product.",
      "order.expectedPrice": "Total",
      "order.checkout": "Complete order",
      "order.pastOrders": "Previous orders",
      "order.removeFromCart": "Remove",
      ...
      "checkout.cartEmpty": "Your cart is empty. Go back and choose a product.",
      "checkout.backToShop": "Back to products",
      "checkout.reviewThanks": "Thank you for your order.",
      "checkout.reviewNote": "You can review your submitted order here at any time. Ready for something else? Start a new pre-order from the cake selection.",
      "checkout.reviewCta": "Start new pre-order",
      ...
      "checkout.invalidName": "Please enter your name.",
      "checkout.invalidEmail": "Only a valid email address is accepted.",
      "checkout.invalidPhone": "Only a valid phone number is accepted.",
      "checkout.cardDetailsTitle": "Card details",
      "checkout.cardholder": "Cardholder name",
      "checkout.cardholderPlaceholder": "As on the card",
      "checkout.cardNumber": "Card number",
      "checkout.cardNumberPlaceholder": "ACCT-000035",
      "checkout.cardExpiry": "Expiry date",
      "checkout.cardExpiryPlaceholder": "MM/YY",
      "checkout.cardCvc": "CVC",
      "checkout.cardCvcPlaceholder": "123",
      "checkout.cardDemoNote": "Demo payment — no real charge is made.",
      "checkout.invalidCardholder": "Please enter the cardholder name.",
      "checkout.invalidCardNumber": "Only a valid-looking card number is accepted.",
      "checkout.invalidCardExpiry": "Only a valid expiry date is accepted (MM/YY).",
      "checkout.invalidCardCvc": "Only a valid CVC is accepted.",
      "checkout.paypalDetailsTitle": "PayPal",
      "checkout.paypalEmail": "PayPal email",
      "checkout.paypalEmailPlaceholder": "paypal@email.com",
      "checkout.paypalConnect": "Connect PayPal account (demo)",
      "checkout.paypalDemoNote": "Demo PayPal — no real PayPal payment.",
      "checkout.invalidPaypalEmail": "Only a valid PayPal email is accepted.",
      ...
      "checkout.successTitleVan": "Order confirmed",
      "checkout.successLeadVan": "Thank you! Your order is recorded. You can pay at the van when you pick up your order.",
      "checkout.successBodyVan": "When the van next visits your town, you can pick up your order. We’ll also notify you by email.",
      "checkout.selectedPayment": "Selected payment method",
      "checkout.orderPayment": "Payment",
      "checkout.pastOrders": "Previous order",
      "checkout.lastOrderTitle": "Submitted order",
      "checkout.addAgain": "Again",
      "checkout.addPastItem": "Add to cart",
    },
  };
