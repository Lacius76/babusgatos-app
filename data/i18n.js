(function () {
  ...
  const MESSAGES = {
    hu: {
      ...
      "push.description": "Ha a furgon a te településedre ér, azonnal szólunk a telefonodon. Csak az érkezésről értesítünk – semmi személyes adatot nem tárolunk.",
    ...
    de: {
      ...
      "push.title": "Benachrichtigung gewünscht",
      "push.description": "Wenn der Transporter in deinem Ort ankommt, benachrichtigen wir dich sofort auf dem Handy. Nur bei Ankunft – keine persönlichen Daten.",
    ...
    en: {
      ...
      "push.description": "When the van reaches your town, we'll alert you instantly on your phone. Arrival only — we store no personal data.",
